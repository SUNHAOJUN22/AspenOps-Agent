...
class Settings:
    ...
    def from_env(cls) -> "Settings":
        roots = tuple(
            ...
            for item in os.getenv("ASPENOPS_ALLOWED_ROOTS", "").split(";")
            if item.strip()
        )
        ...
        return cls(
            ...
            max_retries=_env_int("ASPENOPS_MAX_RETRIES", 1, 0),
            max_batch_points=_env_int("ASPENOPS_MAX_BATCH_POINTS", 100_000),
