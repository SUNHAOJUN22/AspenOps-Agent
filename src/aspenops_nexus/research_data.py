    ...
    def from_dict(cls, data: dict[str, Any]) -> Dataset:
        ...
        if missing_ids:
            raise ResearchValidationError(
                "dataset.record_identity contains undeclared variables: "
                + ", ".join(missing_ids)
            )
        return cls(
            ...
            quality_flags=_json_object(
                mapping.get("quality_flags"), "dataset.quality_flags"
            ),
...
class Target:
    ...
    def from_dict(cls, data: dict[str, Any]) -> Target:
        ...
        return cls(
            ...
            claim_relevance=_strings(
                mapping.get("claim_relevance", []), "target.claim_relevance"
            ),
        )
