...
TARGET = r'''from __future__ import annotations
...
def main() -> None:
    ...
    target = root / "src/aspenops_nexus/optimization.py"
    target.write_text(TARGET, encoding="utf-8")
    (root / "scripts/apply_optimization_strict_types.py").unlink(missing_ok=True)
